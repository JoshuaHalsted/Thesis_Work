...
# Files
RELAP5_inp_file   = "RELAP_FILES/PG_28_Files/PG28_not_filled_dynamic.i"
#RELAP5_inp_file   = "HTTF_base_PG26_splitduct_noSG.i"
RELAP5_out_file   = "RELAP_FILES/PG_28_Files/PG28_filled_dynamic.i"
...
#  mylables = {'20kW_6000CFM': '20kW 2000CFM', '40kW_6000CFM': '40kW 6000CFM', '60kW_6000CFM': '60kW 6000CFM'}
  ...
  fout = open("RELAP_FILES/PG_28_Files/tempout.csv", "w")
  mytemp = ""
  mytempplotnum = ""
...
#  laby = ax2.set_ylabel('kWh')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_TempHE_core_inlet.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured[['TF-1708', 'TF-1736']].mean(axis=1) + 273.15, 'mo-', markevery=13000, label="TF-17xx Block 7, Outer Fuel, avg", markersize=10)
  ...
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_TempHE_core_TOP.png')
...
#  scat = plt.plot(R5data['time-0'], R5data['httemp-150300401'], 'kh-', markevery=200, label="httemp-150300401 block 7, outer fuel pin", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_tempSOLID_core_TOPFuel.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured[['TF-1508', 'TF-1522', 'TF-1536']].mean(axis=1) + 273.15, 'mo-', markevery=13000, label="TF-15xx Block 5, Outer Fuel, avg", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsizeSmall)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_TempHE_core_MID.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured[['TS-1503', 'TS-1517', 'TS-1531']].mean(axis=1) + 273.15, 'm>-', markevery=13000, label="TS-15xx Block 5, Inner Fuel, Sector avg", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_Temp_Selection_only_measured.png')
...
#  ylim = plt.ylim([0.0, 350000.0])
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_PressHE_only_measured.png')
  ...
  try:
    ...
    leg = ax.legend(loc='best', fontsize=lfontsize)
    if savefigures == True:
      fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_HEmassflow.png')
  except KeyError:
    pass
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_SG_level_only_measured.png')
  ...
  try:
    ...
    leg = ax.legend(loc='best', fontsize=lfontsize)
    if savefigures == True:
      fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_RCCS_massFlow_only_measured.png')
  except KeyError:
    pass
  ...
  try:
    ...
    leg = ax.legend(loc='best', fontsize=lfontsize)
    if savefigures == True:
      fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_heater_powers_only_measured.png')
  except KeyError:
    pass
  ...
  try:
    ...
    leg = ax.legend(loc='best', fontsize=lfontsize)
    if savefigures == True:
      fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_RCCS_temp_only_measured.png')
  except KeyError:
    pass
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/Flow_Rate_5' + 'Prod_plenumStrtification_only_measured.png')
