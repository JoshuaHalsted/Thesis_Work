...
# Files
RELAP5_inp_file   = "RELAP_FILES/PG_26_Files/PG26_not_filled.i"
#RELAP5_inp_file   = "HTTF_base_PG26_splitduct_noSG.i"
RELAP5_out_file   = "RELAP_FILES/PG_26_Files/PG26_filled.i"
varlist_file      = "RELAP_FILES/PG_26_Files/R5_initial_cond_list"
instrument_map    = "RELAP_FILES/PG_26_Files/instrumentationmap2018-09-28.csv"
#Measured_data     = "Data/PG26_A_data.csv"
Measured_data     = "RELAP_FILES/PG_26_Files/PG26_Data_Quality.csv"
Measured_data_trend = "RELAP_FILES/PG_26_Files/PG26_A_data.csv"
RELAP5_strip_file = "Strip.i"
RELAP5_output     = "stripf"
RELAP5_output_dir = "RELAP_FILES/PG_26_Files"
...
runtime_for_initial_cond  = 179500.0
...
#  mylables = {'20kW_6000CFM': '20kW 2000CFM', '40kW_6000CFM': '40kW 6000CFM', '60kW_6000CFM': '60kW 6000CFM'}
  ...
  mytemp = ""
  mytempplotnum = ""
  with open(RELAP5_output_dir + '/' + RELAP5_output) as fp:
    start = False
...
#  laby = ax2.set_ylabel('kWh')
      ...
      if savefigures == True:
        fig.savefig(RELAP5_output_dir + '/plots/' + instrument + '.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured[['TF-8201', 'TF-8202', 'TF-8203', 'TF-8204', 'TF-8206', 'TF-8207', 'TF-8208', 'TF-8209', 'TF-8210', 'TF-8211', 'TF-8212', 'TF-8102', 'TF-8103', 'TF-8105', 'TF-8107', 'TF-8108', 'TF-8109', 'TF-8110', 'TF-8111', 'TF-8112']].min(axis=1) + 273.15, 'k>-' , markevery=13000, label="TF-8xxx Upper plenum min.", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempHE_core_inlet.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured[['TF-1708', 'TF-1736']].mean(axis=1) + 273.15, 'mo-', markevery=13000, label="TF-17xx Block 7, Outer Fuel, avg", markersize=10)
  ...
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempHE_core_TOP.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured['TS-1730'] + 273.15, 'r>-', markevery=13000, label="TS-1730 Block 7, Central Refl Middle", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempSOLID_core_TOPInnerRefl.png')
...
#  scat = plt.plot(R5data['time-0'], R5data['httemp-150300401'], 'kh-', markevery=200, label="httemp-150300401 block 7, outer fuel pin", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_tempSOLID_core_TOPFuel.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_tempSOLID_core_TOPOuterRefl.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured[['TF-1508', 'TF-1522', 'TF-1536']].mean(axis=1) + 273.15, 'mo-', markevery=13000, label="TF-15xx Block 5, Outer Fuel, avg", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsizeSmall)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempHE_core_MID.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured['TS-1530'] + 273.15, 'r>-', markevery=13000, label="TS-1530 Block 5, Central Refl Middle", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempSOLID_core_MIDInnerRefl.png')
...
#  scat = plt.plot(R5data['time-0'], R5data['httemp-150300601'], 'kh-', markevery=200, label="httemp-150300601 Block 5, Outer Fuel Pin", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempSOLID_core_MIDFuel.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured[['TS-1503', 'TS-1517', 'TS-1531']].mean(axis=1) + 273.15, 'm>-', markevery=13000, label="TS-15xx Block 5, Inner Fuel, Sector avg", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_Temp_Selection_only_measured.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempSOLID_core_MIDOuterRefl.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured[['TF-1308', 'TF-1322', 'TF-1336']].mean(axis=1) + 273.15, 'mo-', markevery=13000, label="TF-13xx Block 3, Outer Fuel, avg", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsizeSmall)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempHE_core_LOW.png')
...
#  scat = plt.plot(Measured['Run_Time'], Measured['TS-1330'] + 273.15, 'r>-', markevery=13000, label="TS-1330 Block 3, Central Refl Middle", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempSOLID_core_LOWInnerRefl.png')
...
#  scat = plt.plot(R5data['time-0'], R5data['httemp-150300801'], 'kh-', markevery=200, label="httemp-150300801 Block 3, Outer Fuel Pin", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempSOLID_core_LOWFuel.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempSOLID_core_LOWOuterRefl.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempHE_core_Xoutlet.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempHE_core_DT.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempHE_SG_inout.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_TempHE_RCST.png')
...
#  ylim = plt.ylim([0.0, 350000.0])
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_PressHE.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_PressHE_only_measured.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_DP_circ.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_DP_core.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_HEmassflow.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_SG_massFlow.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_SG_temp.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_SG_press.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_SG_level.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_SG_level_only_measured.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_RCCS_massFlow.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_RCCS_massFlow_only_measured.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_heater_powers_only_measured.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_RCCS_temp.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_RCCS_temp_only_measured.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_RCCS_tempDiff.png')
...
#  scat = plt.plot(R5data['time-0'], R5data['cntrlvar-31'], 'bo-', markevery=200, label="cntrlvar-31 SG heat loss", markersize=10)
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_heatBalancePCS.png')
  ...
  leg = ax.legend(loc='best', fontsize=lfontsize)
  if savefigures == True:
    fig.savefig(RELAP5_output_dir + '/plots/' + 'Prod_plenumStrtification_only_measured.png')
