...
# Files
RELAP5_inp_file   = "PG_26_Files/PG26_not_filled.i"
#RELAP5_inp_file   = "HTTF_base_PG26_splitduct.i"
#RELAP5_inp_file   = "HTTF_base_PG26_splitduct_noSG.i"
RELAP5_out_file   = "PG_26_Files/PG26_filled.i"
varlist_file      = "R5_initial_cond_list"
instrument_map    = "instrumentationmap2018-09-28.csv"
Measured_data     = "PG_26_Files/PG26_Data_Quality.csv"
Measured_data_trend = "PG_26_Files/PG26_Data_Trend.csv"
RELAP5_strip_file = "Strip.i"
#RELAP5_output     = "PG26_splitduct_output.o"
RELAP5_output     = "the_strip_file"
...
if generate_list_of_replecements is True:
  varlist = []
...
if check_if_channels_are_in_file:
  ...
  instruments = pd.read_csv(instrument_map, encoding = "UTF-8")
  #print(instruments)
  # drop empty lines (rows)
  instruments.dropna(subset=['Tag_Number'], inplace=True)
  Measured = pd.read_csv(Measured_data, encoding = "UTF-8")
